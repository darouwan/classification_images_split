...
cls_count_df['minimum_count'] = cls_count_df['count'].max() * data_argumentation_threshold
print(cls_count_df)
data_argumentation_df = cls_count_df[cls_count_df['minimum_count'] > cls_count_df['count']]
